...
HOSTNAME=${HOSTNAME:-$(scutil --get HostName)}
...
# Magnify the icon as the mouse passes over
...
for app in "cfprefsd" "Calendar" "Contacts" "Dock" "Finder" "Safari" "SystemUIServer" "iCal" "iTunes"; do
